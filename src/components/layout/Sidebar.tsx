...
const vaultCoreNavItems: NavItem[] = [
  ...
  { label: "Meta Campaign Drafts", href: "/meta-campaign-drafts", icon: Target, permission: "canViewApprovals" },
  { label: "Finance Drafts",    href: "/finance-drafts",  icon: Receipt,       permission: "canViewApprovals" },
  { label: "Creative Briefs",   href: "/creative-briefs", icon: Clapperboard,  permission: "canViewApprovals" },
...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  const VAULT_CORE_ROUTES = ["/vault-core", "/vault-memory", "/workforce", "/recommendations", "/drafts", "/proposals", "/runtime", "/actions", "/ghl-workflows", "/message-drafts", "/meta-campaign-drafts", "/finance-drafts", "/creative-briefs"];

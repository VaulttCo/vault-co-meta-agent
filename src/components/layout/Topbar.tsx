...
const pageTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  "/ai-agent/console": { title: "Veronica Console", subtitle: "AI Growth Operator — Campaign strategy, client intelligence, creative analysis, and approval-ready growth plans." },
  "/ai-agent": { title: "Veronica AI", subtitle: "Veronica Meta AI — fulfillment portal, client intelligence, and campaign pipeline overview" },

...
export const FINANCE_TEMPLATES: FinanceTemplate[] = [
  {
    ...
    title: "Setup Fee Invoice Draft",
    description: "One-time onboarding / setup fee invoice draft for a new client.",
  ...
  },
  {
    ...
    title: "Revenue Share Invoice Draft",
    description: "Performance revenue-share invoice draft (e.g. 5% of extra revenue).",
  ...
  },
  {
    ...
    title: "Partner Split Summary",
    description: "Internal summary of how fees/revenue split between partners for a period.",
  ...
  },
  {
    ...
    description: "End-of-month revenue closeout summary for review and lock.",
  ...
  },
  {
    ...
    title: "Payment Follow-Up Draft",
    description: "Internal note proposing a professional, non-threatening payment follow-up.",
  ...
  },
  {
    ...
    title: "Overdue Invoice Review",
    description: "Internal review note for an invoice flagged past due.",
  ...
  },
  {
    ...
    title: "Commission Calculation Draft",
    description: "Internal commission/attribution calculation for a period.",
  ...
  },
  {
    ...
    title: "Revenue Attribution Review",
    description: "Internal review of how revenue is attributed to campaigns/sources.",
    amount_summary: "Attribution review for {{period}} (advisory, internal)",
    calculation: "Maps attributed revenue to sources/campaigns using internal tracking evidence.",
    line_items: [li("Attributed revenue ({{source}})", "{{attributed_value}}", "Tracked")],
    payment_terms: "N/A (internal review)",
    missing_inputs: ["Confirm tracking source", "Confirm attribution window"],
    compliance_notes: ["Attribution must be evidence-based; flag gaps before using it to bill revenue share."],
    evidence: ["Tracking/attribution evidence (Vega)", "Campaign context (Valentina/Veronica)"],
    suggested_owner: "Valerie (with Vega/Valentina)",
    notes: "Feeds revenue-share and commission drafts; review only.",
  },
  {
    key: "refund_review",
    finance_type: "refund_review",
    title: "Refund Review",
    description: "Internal review note for a requested or proposed refund.",
  ...
  },
  {
    ...
    finance_type: "custom",
    title: "Custom Finance Draft",
    description: "Blank, structured starting point for a bespoke finance artifact.",

...
// Detects placeholder values so the mock fallback stays active
// until real Supabase credentials are provided.
// ─────────────────────────────────────────────────────────────
...
export function isSupabaseReallyConfigured(): boolean {

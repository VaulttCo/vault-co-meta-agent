...
2. **Workforce Agents** — specialized executives ◐ (Vega + Victoria active; 4 stubs)
...
1. **Activate executive #3** — Valerie (Financial) or Veronica (Lead): read-only analysis cycles.
2. **Collaboration depth** — multi-round agent dialogue; Veronica/Vanessa join the standard flow.
